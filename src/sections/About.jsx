      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start mt-8">
        ...
        <div className="lg:col-span-7 flex flex-col gap-6 w-full">
          ...
          <motion.div
            ...
            className="glassmorphism relative rounded-3xl p-6 sm:p-8 flex flex-col gap-6 overflow-hidden border border-white/5 hover:border-purple-500/20 transition-all duration-500 group shadow-lg"
          >
            ...
            <div className="flex flex-col gap-3">
              <div className="inline-flex items-center gap-1.5 self-start py-1 px-3 rounded-full bg-purple-500/10 border border-purple-500/20 text-[10px] font-bold text-purple-400 uppercase tracking-widest">
            ...
            <div className="flex flex-col gap-4 text-sm sm:text-base text-gray-400 leading-relaxed font-light">
              <p className="border-l-2 border-purple-500/30 pl-4">{aboutMe}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2 border-t border-white/[0.06] pt-6">
              <div className="flex items-start gap-3">
                <div className="p-2 bg-pink-500/10 border border-pink-500/20 text-pink-400 rounded-xl mt-0.5 shrink-0">
          ...
          <div className="grid grid-cols-2 gap-4 mt-2 w-full">
            {stats.map((stat, i) => (
              <Card
                ...
                index={i + 1}
                direction="up"
                className="group relative flex flex-col items-center justify-center text-center py-6 px-4 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-xl transition-all duration-500 hover:scale-[1.03] hover:border-purple-500/20 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.7),_0_0_30px_rgba(168,85,247,0.12)] overflow-hidden"
              >
                {/* Spotlight Background Glow */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.08)_0%,transparent_70%)] pointer-events-none" />

                {/* Animated Top Border Line */}
                <div className="absolute top-0 left-0 w-full h-[2.5px] bg-gradient-to-r from-transparent via-purple-500/40 to-transparent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-center" />

                {/* Stat Value with customized neon gradient text */}
                <span className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white via-neutral-200 to-purple-400 mb-1 group-hover:from-pink-400 group-hover:to-purple-400 transition-all duration-500 font-sans tracking-tight">
                  {stat.value}
                </span>
